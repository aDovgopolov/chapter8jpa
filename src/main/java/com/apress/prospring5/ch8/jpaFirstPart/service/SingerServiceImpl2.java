...
import com.apress.prospring5.ch8.jpaFirstPart.repos.SingerRepository;
...
public class SingerServiceImpl2 implements SingerService {
    ...
    public List<Singer> findAll() {
        List<Singer> list = Lists.newArrayList(singerRepository.findAll());
        return  list;// JPA API
